  ...
  return (
    <div className="min-h-screen bg-linear-to-b from-[#2d6260] via-[#204947] to-[#122b2a] flex items-center justify-center pt-20 pb-5 px-4">
      ...
      <motion.div 
        ...
        initial="hidden"
        animate="visible"
        className="w-full max-w-4xl bg-[#183b3a]/80 backdrop-blur-xl border border-white/10 rounded-3xl shadow-2xl overflow-hidden grid grid-cols-1 md:grid-cols-2"
      >
        
        {/* Left Side: Textured Teal Image Banner */}
        <div className="relative min-h-55 md:min-h-125 flex flex-col justify-between p-8 overflow-hidden bg-[#1f4846]">
          {/* Background Image with linear Overlay & Slow ambient motion */}
          ...
          <motion.div variants={itemVariants} className="relative z-10 my-auto pt-3">
            <h2 className="text-7xl font-serif text-emerald-50 mb-2">
              Welcome Back.
            </h2>
            <p className="text-sm text-emerald-100/70 font-light leading-relaxed">
              Access your tenant dashboard and manage your properties effortlessly.
            </p>
          </motion.div>
        ...
        <div className="p-8 sm:p-12 flex flex-col justify-center bg-[#153433]/90">
          <motion.div variants={itemVariants} className="mb-8">
            <h3 className="text-2xl font-serif text-white mb-1">Sign In</h3>
          ...
          <form onSubmit={(e) => e.preventDefault()} className="space-y-5">
            ...
            <motion.p variants={itemVariants} className="text-center text-xs text-emerald-100/60 pt-4">
              ...
              <Link to="/signup" className="text-emerald-300 hover:underline font-medium ml-1 inline-block">
                Sign Up
              </Link>
            </motion.p>
          </form>
