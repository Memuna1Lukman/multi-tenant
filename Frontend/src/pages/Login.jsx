...
export default function Login() {
  return (
    <div className="min-h-screen bg-linear-to-b from-[#2d6260] via-[#204947] to-[#122b2a] flex items-center justify-center p-4 sm:p-6">
      ...
      <div className="w-full max-w-4xl bg-[#183b3a]/80 backdrop-blur-xl border border-white/10 rounded-3xl shadow-2xl overflow-hidden grid grid-cols-1 md:grid-cols-2">
        ...
        <div className="p-8 sm:p-12 flex flex-col justify-center bg-[#153433]/90">
          ...
          <form onSubmit={(e) => e.preventDefault()} className="space-y-5">
            ...
            <p className="text-center text-xs text-emerald-100/60 pt-4">
              ...
              <Link to="/signup" className="text-emerald-300 hover:underline font-medium ml-1">
                Sign Up
              </Link>
            </p>
          </form>
